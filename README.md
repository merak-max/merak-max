...
Full-stack developer building practical AI-powered web applications with React, TypeScript, Node.js, and Express.

I enjoy turning ideas into working products across the frontend and backend. My current focus is reliable AI integration, secure APIs, data persistence, automated testing, and production deployment.
...
- [Portfolio](https://hemant-portfolio-hazel.vercel.app)
- [GitHub](https://github.com/merak-max)

I am actively improving these projects and documenting the engineering decisions behind them.
